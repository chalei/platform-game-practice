...
animation_database['run'] = load_animation('player_animations/run',[6,6,6,6,6,6,6,6,6,6])
animation_database['idle'] = load_animation('player_animations/idle',[3,3,3,3,3,3,3,3,3,3,3,3])
animation_database['jump'] = load_animation('player_animations/jump',[2,2,2,2,4,4,4,4,4,6,6,6,6])
game_map = {}
...
player_rect = pygame.Rect(100,100,32,32) #ganti frame pixel char
